...
public class RequiresParseDetailAspect {
    ...
    @Before("this(com.mp4parser.support.AbstractBox) && ((execution(public * * (..)) && !( " +
            ...
            "!@annotation(com.mp4parser.support.DoNotParseDetail)) || @annotation(com.mp4parser.support.ParseDetail))")
