...
public class H264TrackImplTest {
    ...
    public void freeze() throws IOException {
        DataSource fc = new FileDataSourceImpl(getClass().getProtectionDomain().getCodeSource().getLocation().getFile() + "/com/mp4parser/authoring/tracks/h264-sample.h264");
...
/*        WritableByteChannel fcOut = new FileOutputStream("h264-sample.mp4").getChannel();
        ...
        IsoFile isoFileReference = new IsoFile(
                new FileInputStream(
                        getClass().getProtectionDomain().getCodeSource().getLocation().getFile() + "com/mp4parser/authoring/tracks/h264-sample.mp4").getChannel());
