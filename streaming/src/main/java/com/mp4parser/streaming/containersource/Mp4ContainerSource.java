...
public class Mp4ContainerSource implements Callable<Void> {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            mp4ContainerSource = new Mp4ContainerSource(new URI("http://com.mp4parser.s3.amazonaws.com/org.mp4parser.examples/Cosmos%20Laundromat%20small%20faststart.mp4").toURL().openStream());
