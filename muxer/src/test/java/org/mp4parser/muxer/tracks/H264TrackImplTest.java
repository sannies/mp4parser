...
public class H264TrackImplTest {
    ...
    public void freeze() throws IOException, URISyntaxException {
        DataSource fc = new FileDataSourceImpl(getClass().getClassLoader().getResource("org/mp4parser/muxer/tracks/h264-sample.h264").toURI().getPath());
      ...
      // c.writeContainer(new FileOutputStream("/Users/sannies/dev/mp4parser/muxer/src/test/resources/org/mp4parser/muxer/tracks/h264-sample.mp4").getChannel());
        ...
        IsoFile isoFileReference = new IsoFile(getClass().getClassLoader().getResource("org/mp4parser/muxer/tracks/h264-sample.mp4").toURI().getPath());
