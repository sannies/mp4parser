...
public class H264TrackImplTest {
    ...
    public void freeze() throws IOException {
        DataSource fc = new FileDataSourceImpl(getClass().getProtectionDomain().getCodeSource().getLocation().getFile() + "/com/mp4parser/muxer/tracks/h264-sample.h264");
        ...
        IsoFile isoFileReference = new IsoFile(getClass().getProtectionDomain().getCodeSource().getLocation().getFile() + "com/mp4parser/muxer/tracks/h264-sample.mp4");
